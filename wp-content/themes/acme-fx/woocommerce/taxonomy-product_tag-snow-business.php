<?php
/**
 * This template displays the Product Tag taxonomy term archive for the term Snow Business
 *
...
//  th--  add snow flakes to Snow Business tag page
add_action( 'woocommerce_before_main_content', 'th_snow_business_flakes' );
function th_snow_business_flakes () {
	echo '<div>
